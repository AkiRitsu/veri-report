            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <span class="badge badge-warning">{{ $user->ongoing_count }}</span>
                    </td>
                </tr>
                @endforeach
            </tbody>
                    ...
                    <td style="text-align: center;">
                        <div class="actions-grid">
                            @if($report->status === 'on-going')
                                ...
                                <form method="POST" action="{{ route('reports.complete', $report) }}">
                                    @csrf
                            ...
                            @else
                                ...
                                <form method="POST" action="{{ route('reports.send-email', $report) }}">
                                    @csrf
